...
def home():
    if request.method == "POST":
        ...
        #
        if prediction == 0:
            prediction = "Person is not suffering from brain stroke"
        else:
            prediction = "Person is suffering from brain stroke"

        return render_template("index.html", prediction_text="Chances of Brain Stroke Prediction is --> {}".format(prediction))
